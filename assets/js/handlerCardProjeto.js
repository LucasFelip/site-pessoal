...
const cardProjetsContainer = document.getElementById('projetosContainer');

cardsProjets.forEach(card => {
    const cardHTML = criarCard(card);
    cardProjetsContainer.insertAdjacentHTML('beforeend', cardHTML);
});
